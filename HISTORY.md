...
**How to upgrade**: Open your command-line and execute this command: `go get -u gopkg.in/Likeyn/iris.v6`.
...
- `import "github.com/iris-contrib/middleware/basicauth"` -> `import "gopkg.in/Likeyn/iris.v6/middleware/basicauth"`
- `import "github.com/iris-contrib/middleware/i18n"` -> `import "gopkg.in/Likeyn/iris.v6/middleware/i18n"`
- `import "github.com/iris-contrib/middleware/logger"` -> `import "gopkg.in/Likeyn/iris.v6/middleware/logger"`
- `import "github.com/iris-contrib/middleware/recovery"` -> `import "gopkg.in/Likeyn/iris.v6/middleware/recover"`


- `import "github.com/iris-contrib/plugin/typescript"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/typescript"`
- `import "github.com/iris-contrib/plugin/editor"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/typescript/editor"`
- `import "github.com/iris-contrib/plugin/cors"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/cors"`
- `import "github.com/iris-contrib/plugin/gorillamux"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/gorillamux"`
- `import github.com/iris-contrib/plugin/oauth"` -> `import "github.com/iris-contrib/adaptors/oauth"`


- `import "github.com/kataras/go-template/html"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/view"`
- `import "github.com/kataras/go-template/django"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/view"`
- `import "github.com/kataras/go-template/pug"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/view"`
- `import "github.com/kataras/go-template/handlebars"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/view"`
- `import "github.com/kataras/go-template/amber"` -> `import "gopkg.in/Likeyn/iris.v6/adaptors/view"`
...
import (
  ...
  "gopkg.in/Likeyn/iris.v6/adaptors/httprouter" // <---- NEW
)
...
import (
  "gopkg.in/Likeyn/iris.v6"
  "gopkg.in/Likeyn/iris.v6/adaptors/gorillamux" // <---- NEW
)
...
import (
	"gopkg.in/Likeyn/iris.v6"
	"gopkg.in/Likeyn/iris.v6/adaptors/gorillamux" // <--- NEW (previous section)
	"gopkg.in/Likeyn/iris.v6/adaptors/view" // <--- NEW it contains all the template engines
)
...
**AFTER**
```go
import ""gopkg.in/Likeyn/iris.v6/adaptors/view"
// ...
app := iris.New()
...
import (
	"gopkg.in/Likeyn/iris.v6"
  "gopkg.in/Likeyn/iris.v6/adaptors/gorillamux"
)
...
func main() {
	...
	// OPTIONALLY:
	// import "gopkg.in/Likeyn/iris.v6/adaptors/sessions/sessiondb/redis"
...
import (
	"gopkg.in/Likeyn/iris.v6"
  "gopkg.in/Likeyn/iris.v6/adaptors/httprouter"
  "gopkg.in/Likeyn/iris.v6/adaptors/cors"
)
