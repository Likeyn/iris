...
<a href="https://godoc.org/gopkg.in/Likeyn/iris.v6"><img src="https://img.shields.io/badge/docs-%20reference-5272B4.svg?style=flat-square" alt="Docs"></a>
...
```sh
$ go get gopkg.in/Likeyn/iris.v6
```
...
5. [Godocs](https://godoc.org/gopkg.in/Likeyn/iris.v6) for deep documentation
